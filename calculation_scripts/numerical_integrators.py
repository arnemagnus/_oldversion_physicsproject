...
#                 Added implementation of the Fehlberg adaptive step
#                 size method.
...
def fehlberg(t,           # Current time
   ...
   # Fehlberg adaptive integrator scheme. If the new step is not
   # accepted, the time and coordinates are not updated.
   ...
   err = np.fmax(np.sqrt((x_4-x_5)**2)/sc)
