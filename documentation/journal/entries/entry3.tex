...
\begin{table}[H]
    ...
    The first row of $b$-coefficients yield the $5^{\mathrm{th}}$ order solution, 
    while the second row yields the $4^{\mathrm{th}}$ order interpolant. See~\cite{prince1981highorder}.}
